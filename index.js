...
(function() {
  emailjs.init("JKOou6Kbc_j92zBU0"); // Reemplaza 'YOUR_USER_ID' con el ID de usuario de EmailJS
})();
...
document.getElementById('contactForm').addEventListener('submit', function(e) {
  ...
  // Si todo es válido, envía el formulario a EmailJS
  emailjs.sendForm('service_gjjettg', 'template_mpyysgv', this)
